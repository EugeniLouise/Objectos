...
omie_price1 = Market(date="omie_price", value="2023-05-18", 2.5)
canarias_price1 = Market("canarias_price", "2023-05-18", 3)
baleares_price1 = Market("baleares_price", "2023-05-18", 4)
